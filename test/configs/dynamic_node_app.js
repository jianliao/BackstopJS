 ...
 */
const exampleConfig = {
  // incremental flag -- surpresses cleaning reference directory durning reference command
  i: true,
  config: {
    // when truthy backstop will assume one dynamic scenario which is appended to test report belonging to dynamicTestId
    dynamicTestId: argsOptions.dynamicTestId,
